...
<!-- 	<table class="liststyle full">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
						<a href="<?php echo U('Admin/Category/add',array('pid'=>$vo['id']));?>" class="abtn"><em class="btn-icon icon-plus-sign"></em>增加子类</a>
						<a href="<?php echo U('Admin/Category/edit',array('id'=>$vo['id']));?>" class="abtn"><em class="btn-icon icon-edit"></em>修改信息</a>&nbsp;
						<a onclick="javascript:return p_del()"  href="<?php echo U('Admin/Category/delete',array('id'=>$vo['id']));?>" class="abtn"><em class="btn-icon icon-trash"></em>删除</a>
						<!--<a href="<?php echo U('Admin/Article/index',array('id'=>$vo['id']));?>" class="abtn"><em class="btn-icon  icon-list-alt"></em>查看文章</a>-->					
