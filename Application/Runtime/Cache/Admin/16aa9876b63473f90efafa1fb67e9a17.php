	...
	<div class="container">
		<header class="top clearfix">
			<a href="#" class="logo" title="黄金珠宝知识数据库管理平台"></a>
				...
				<nav class="navs">
					<a href="/gold/index.php/Admin/Stat">主页</a>
				</nav>
		...
		<section class="main clearfix">
			<aside class="sidebar1">
				...
				<dl class="menu">
					...
					<dd><a href="<?php echo U('Admin/Stat/year');?>"><em class="menu-icon icon-plus"></em>时间统计</a></dd>
					<dt>附件管理</dt>
...
<!-- 	<table class="liststyle full">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td><?php echo ($vo["stat_year"]); ?></td>
					<td><?php echo ($vo["all_click"]); ?></td>
					<td>
						<a href="<?php echo U('Admin/Stat/month',array('year'=>$vo['stat_year']));?>" class="abtn" title="查看月统计"><em class="btn-icon icon-list-alt"></em>查看月统计</a>
					</td>					
