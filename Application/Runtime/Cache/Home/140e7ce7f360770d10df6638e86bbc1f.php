...
<script type="text/javascript" src="/gold/Public/ueditor/ueditor.parse.min.js"></script>
<script>
    $(function(){
            uParse('.content',{
                rootPath : '/gold/Public/ueditor/',
            })
    })
</script>
...
<body>
    ...
    <div class="content">
        ...
        <div class="news_time">发布时间：<?php echo (date("Y-m-d H:i",$article["create_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;浏览次数：<?php echo ($article["click"]); ?></div>
        <div style="min-height:550px;" class="news_Content">
